...
const Landing = () => {
  ...
  return (
    <div className="bg-white w-full">
      ...
      {/* Services Section  */}
      <section className="px-40 max-sm:px-4 max-md:px-8">
        <div
          className="bg-black mx-auto px-[20.5px] max-sm:px-3 rounded-3xl"
          style={{
        ...
        >
          ...
          {/* Service Grid */}
          <div className="flex flex-wrap justify-around gap-5 pb-20">
            {ServicesImage.map ((service, index) => (
              <div
                key={index}
                className="group bg-[#ececec] rounded-xl w-72 max-sm:w-full h-48 overflow-hidden hover:scale-105 transition-all duration-500 loadingChild"
              >
      ...
      <section className="bg-white px-[120px] max-sm:px-3 py-5">
        <div>
          <h1 className="mb-10 font-yeseva text-[#222222] text-[152px] max-sm:text-[52px] max-md:text-[100px]">
            port
            <span className="text-stroke-yellow text-transparent">folio</span>
          </h1>
        </div>
        <div className="pt-14">
      ...
      <section
        className="bg-gray-50 px-[120px] max-sm:px-3 py-5"
        style={{
          backgroundImage: `radial-gradient(circle at 0.5px 0.5px ,#ebc52a50 0.9px,transparent 0)`,
          backgroundSize: '8px 8px',
        }}
