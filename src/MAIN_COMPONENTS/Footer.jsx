...
export default function Footer () {
  return (
    <div className="flex flex-col justify-center items-center bg-black py-[30px]">
      <div className="flex flex-col justify-center items-center max-w-[513px] text-center">
        <div className="max-w-52">
          <img src={logo} alt="laxya" />
        </div>
        <p className="py-7 font-semibold text-[#C0C0C7] text-[15px]">
        ...
        <div className="flex justify-center items-center gap-4 mt-[30px]">
          <a
            ...
            target="_blank"
          >
            <i className="pt-[10px] text-white group-hover:text-yellow fa-brands fa-facebook-f" />
          </a>
          <a
            href="https://in.linkedin.com/company/laxyaproductions"
            className="group border border-[#c0c0c75b] hover:border-yellow w-[38px] h-[38px]"
          >
            <i className="pt-[10px] text-white group-hover:text-yellow fa-brands fa-linkedin-in" />
          </a>
          <a
            href="https://www.instagram.com/laxya_productions/"
            className="group border border-[#c0c0c75b] hover:border-yellow w-[38px] h-[38px]"
          >
            <i className="pt-[10px] text-white group-hover:text-yellow fa-brands fa-instagram" />
          </a>
          <a
            href="https://www.youtube.com/@laxyaproductions"
            className="group border border-[#c0c0c75b] hover:border-yellow w-[38px] h-[38px]"
          >
            <i className="pt-[10px] text-white group-hover:text-yellow fa-brands fa-youtube" />
          </a>
        </div>
      </div>
