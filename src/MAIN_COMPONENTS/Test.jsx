...
import show_Reel from '../Images/ShowReel.mp4';
import logoWhite from '../Images/Logos/laxya-white.png';
  ...
  return (
    <div className="px-12 overflow-hidden select-none">
      <div className="relative w-full h-screen text-white">
        ...
        <div className="top-0 left-0 z-10 absolute flex flex-col w-full">
